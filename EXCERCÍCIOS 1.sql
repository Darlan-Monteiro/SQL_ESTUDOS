...
-- Você é responsável pelo setor de logística da empresa Contoso e precisa dimensionar o
...
-- Imagine que você precise extrair um relatório da tabela DimStore, com informações de lojas. 
...
-- Faça uma lista com todos os produtos das cores: Green, Orange, Black, Silver e Pink. 
